  ...
  return (
    ...
    >
      <Animated.Image
        ...
        source={AppImages.welcomeImage}
      />
      <Animated.Text
        testID="SplashWelcomeView_Title"
        accessibilityLabel="SplashWelcomeView_Title"
        style={[styles.title, { transform: [{ translateX: welcomeTextAnim }] }]}
      >
        {Values.Splash.welcome}
      </Animated.Text>
      <Text style={styles.subtitle}>
        {Values.Splash.welcomeDescription}
      </Text>
    </Animated.View>
  );
};
